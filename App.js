...
const App = () => {
            ...
            setTimeout(() => {
              ...
              BleManager.retrieveServices(peripheral.id).then(
                (peripheralInfo) => {
                  ...
                  console.log("bakeCharacteristic::", bakeCharacteristic);
                  console.log("crustCharacteristic::", crustCharacteristic);
  ...
  const renderItem = (item) => {
    const color = item.connected ? "#e2e2d2" : "#fff";
    return (
